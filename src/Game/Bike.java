 ...
 *
 * @author Arbab Ali
 *   Bike class that defines bike sprite 
 */
  ...
  * @param color 
  */
    public Bike(String name,Integer number,int x, int y, int width, int height, Image image,Color color) {
     ...
     * @return 
     */
    public boolean collision(Bike other)
    {
